...
import type { Mood, TravelerType, TripRequest } from "@/lib/validation/trip";
...
export default async function EscapePage({params,searchParams}:Props){
 ...
 return <V33EscapeBuilderClient slug={slug} name={destination.nameEl} nameEn={destination.nameEn} trip={trip} offers={offers}/>;
}
