...
export default async function StayEscapePage({params,searchParams}:Props){
 ...
 const selected=directSelected??(await loadV8StayOffers(slug,start,end,20).catch(()=>[])).find(x=>x.sourceProductId===offerId)??null;
