...
async function main(){
 ...
 assert(ordinaryIdeaNonEmpty/Math.max(1,ordinaryIdea)>=.9,`Ordinary selected-city non-empty rate ${(ordinaryIdeaNonEmpty/Math.max(1,ordinaryIdea)*100).toFixed(1)}%`);
