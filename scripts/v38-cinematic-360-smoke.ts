...
const v50=home.includes("V50TravelIntelligenceHome"),v40=home.includes("V40DiscoveryExperience");
const funnel=read(v50?"components/v50-travel-intelligence-home.tsx":v40?"components/v40-discovery-experience.tsx":"components/v38-escape-funnel.tsx");
const builder=read((v50||v40)?"components/v40-stay-workspace.tsx":"components/v38-escape-builder-client.tsx");
...
const agent=v50?read("app/api/v50/agent/route.ts"):"";
...
expect(
  v50?funnel.includes("/api/v50/hero-media")&&funnel.includes("heroMedia"):funnel.includes("mode=aerial"),
...
expect(
  (v50||v40)?(builder.includes("stayImages")&&builder.includes("extra_images")&&builder.includes("mode=aerial"))
...
expect(
  (v50||v40)?(builder.includes("unlocked")&&builder.includes("/api/guide/email")&&builder.includes("offer.trackingUrl"))
...
expect(
  ...
  &&(v50?agent.includes("assessStayAvailabilityV20")&&agent.includes("trackingUrl:offer.trackingUrl"):true),
...
console.log(`V38_TRUTH_CONTRACTS_OK active=${v50?"V50":v40?"V40":"V38"} media=sourced local=multi-source price=truthful feedback=sample-gated pdf=affiliate-disclosed email=gated`);
