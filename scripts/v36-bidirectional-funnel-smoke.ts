...
expect(v42.includes("trackingUrl:x.row.tracking_url"),"original affiliate tracking URL must be preserved in V42");
expect(legacyRanker.includes("loadV8StayOffers")&&legacyRoute.includes("forward-recovery"),"V36 fallback architecture must remain available during V42 rollout");
