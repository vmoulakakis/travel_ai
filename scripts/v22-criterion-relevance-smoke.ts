...
assert.match(health,/release:"V50"/,"health contract must expose the active V50 release");assert.match(health,/engineVersion:\"V26\"/);assert.match(health,/choiceProfilesReady/);assert.match(health,/criterionSensitivityGate:true/);assert.match(health,/negationSafeStayEvidence:true/);
