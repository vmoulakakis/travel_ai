...
const recommendation = {
  ...
  regionGroup: "peloponnese", role: "BEST FIT", explorationRole:"BEST_FIT", explorationReason:"Η ισχυρότερη συνολική ισορροπία.", score: 88, fitStatus: "strong", confidence: "HIGH", why: "Ταιριάζει στον ρυθμό σου.",
